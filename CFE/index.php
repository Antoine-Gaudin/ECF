...
<div class="card mb-3" style="max-width: 100%;">
  <div class="row g-0">
    <div class="col-md-4">
      <img src="logo.jpeg" class="img-fluid rounded-start" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title">Etablissement n°1</h5>
        ...
        <a href="etablissement01.php" class="btn btn-primary">voir plus</a>
      </div>
    </div>
  </div>
</div>
<div class="card mb-3" style="max-width: 100%;">
  <div class="row g-0">
    ...
    <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title">Etablissement n°2</h5>
        <p class="card-text">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Alias nihil, voluptatibus doloremque adipisci unde nulla, optio numquam placeat eveniet beatae sequi. Alias aut quas ipsum. Officiis inventore minima sint laudantium!</p>
        <a href="etablissement02.php" class="btn btn-primary">voir plus</a>
      </div>
    </div>
  </div>
</div>
<div class="card mb-3" style="max-width: 100%;">
  <div class="row g-0">
    ...
    <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title">Etablissement n°3</h5>
        <p class="card-text">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Alias nihil, voluptatibus doloremque adipisci unde nulla, optio numquam placeat eveniet beatae sequi. Alias aut quas ipsum. Officiis inventore minima sint laudantium!</p>
        <a href="etablissement03.php" class="btn btn-primary">Détails</a>
      </div>
    </div>
  </div>
</div>
<div class="card mb-3" style="max-width: 100%;">
  <div class="row g-0">
    ...
    <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title">Etablissement n°4</h5>
        <p class="card-text">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Alias nihil, voluptatibus doloremque adipisci unde nulla, optio numquam placeat eveniet beatae sequi. Alias aut quas ipsum. Officiis inventore minima sint laudantium!</p>
        <a href="etablissement04.php" class="btn btn-primary">Details</a>
      </div>
    </div>
  </div>
</div>
<div class="card mb-3" style="max-width: 100%;">
  <div class="row g-0">
    ...
    <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title">Etablissement n°5</h5>
        <p class="card-text">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Alias nihil, voluptatibus doloremque adipisci unde nulla, optio numquam placeat eveniet beatae sequi. Alias aut quas ipsum. Officiis inventore minima sint laudantium!</p>
        <a href="etablissement05.php" class="btn btn-primary">voir plus</a>
      </div>
    </div>
  </div>
</div>
<div class="card mb-3" style="max-width: 100%;">
  <div class="row g-0">
    ...
    <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title">Etablissement n°6</h5>
        <p class="card-text">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Alias nihil, voluptatibus doloremque adipisci unde nulla, optio numquam placeat eveniet beatae sequi. Alias aut quas ipsum. Officiis inventore minima sint laudantium!</p>
        <a href="etablissement06.php" class="btn btn-primary">voir plus</a>
      </div>
    </div>
  </div>
</div>
<div class="card mb-3" style="max-width: 100%;">
  <div class="row g-0">
    ...
    <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title">Etablissement n°7</h5>
        <p class="card-text">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Alias nihil, voluptatibus doloremque adipisci unde nulla, optio numquam placeat eveniet beatae sequi. Alias aut quas ipsum. Officiis inventore minima sint laudantium!</p>
        <a href="etablissement07.php" class="btn btn-primary">voir plus</a>
      </div>
    </div>
  </div>
</div>
